    ...
    public class ReportInitializer
    {
        public static async Task Initialize(ApplicationDbContext context)
        {
            ...
            var reports = new Report[]{
               ...
               new Report{Title = "Bao cáo ti le thua lỗ", Project = context.Projects.FirstOrDefault(s =>s.Name=="Du an 2"), ShortContent="Tạchd", Content="Tạch", CreatedOn = DateTime.Now, Department = context.Departments.FirstOrDefault(d =>d.Code=="vntt-kd"), From = context.ApplicationUsers.FirstOrDefault(a => a.Email=="tranphuchau.it@gmail.com"), To= new HashSet<ApplicationUserReport>{new ApplicationUserReport{ ApplicationUser = context.ApplicationUsers.FirstOrDefault(a => a.Email=="a@a.com")}}, HighestChildDepartmentsOfTo=new HashSet<ReportDepartment>{ new ReportDepartment { Department = context.Departments.FirstOrDefault(d => d.Name =="VNTT")}, new ReportDepartment { Department = context.Departments.FirstOrDefault(d => d.Code == "vntt-kd") } }},
            };
