...
namespace ReportSystemWebApplication.Data
{
    public class DbInitializer
    {
        public static async Task Initialize(ApplicationDbContext context)
        {
            ...
            var rootDepartment = new Department { Name = "Ban Giám Đốc", Level = 1, Code = "bgd", Suffix = "@becamex.com.vn" };
            context.Departments.Add(rootDepartment);
            await context.SaveChangesAsync();

            var mainDepartment1 = new Department { Name = "VNTT", Level = 2, Code = "vntt", Parent = context.Departments.FirstOrDefault(d => d.Name == "Ban Giám Đốc"), Suffix = "@vntt.com.vn" };
            context.Departments.Add(mainDepartment1);
            await context.SaveChangesAsync();

            var mainDepartment2 = new Department { Name = "Trung tâm R&D", Level = 3, Code = "vntt_r&d", Parent = context.Departments.FirstOrDefault(d => d.Name == "VNTT"), Suffix = "@rd.com.vn" };
            context.Departments.Add(mainDepartment2);
            await context.SaveChangesAsync();
            // var subDepartment1 = new Department { Name = "VNTT - Kinh Doanh", Code = "vntt-kd", Level = 3, Parent = context.Departments.FirstOrDefault(d => d.Name == "VNTT"), Suffix = "@vntt.com.vn" };
            // var subDepartment2 = new Department { Name = "VNTT - R&D", Code = "vntt-rd", Level = 3, Parent = context.Departments.FirstOrDefault(d => d.Name == "VNTT"), Suffix = "@vntt.com.vn" };
            ...
            // context.Departments.Add(mainDepartment2);
            // await context.SaveChangesAsync();
            // var subDepartment3 = new Department { Name = "EIU - Kinh Doanh", Code = "eiu-kd", Level = 3, Parent = context.Departments.FirstOrDefault(d => d.Name == "EIU"), Suffix = "@eiu.edu.vn" };
            // var subDepartment4 = new Department { Name = "EIU - Nhân sự", Code = "eiu-ns", Level = 3, Parent = context.Departments.FirstOrDefault(d => d.Name == "EIU"), Suffix = "@eiu.edu.vn" };
